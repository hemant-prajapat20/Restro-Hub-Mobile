...
const styles = StyleSheet.create({
  ...
  kpiCard: { backgroundColor: '#fff', padding: 16, borderRadius: 16, borderWidth: 1, borderColor: '#E2E8F0', width: 200, marginRight: 12 },
  kpiLabel: { fontSize: 10, fontWeight: '800', color: '#94A3B8', textTransform: 'uppercase' },
  kpiValue: { fontSize: 24, fontWeight: '800', color: '#0F172A', marginVertical: 4 },
  kpiSub: { fontSize: 10, fontWeight: '700', color: '#64748B' },
  ...
  aiBanner: { backgroundColor: '#FEF3C7', padding: 16, borderRadius: 16, marginBottom: 16, borderWidth: 1, borderColor: '#FDE68A' },
  aiBannerTitle: { fontSize: 14, fontWeight: '800', color: '#B45309', marginBottom: 6 },
  aiBannerText: { fontSize: 12, color: '#92400E', lineHeight: 18, marginBottom: 12 },
  aiBtn: { backgroundColor: '#F59E0B', alignSelf: 'flex-start', paddingHorizontal: 16, paddingVertical: 8, borderRadius: 8 },
  aiBtnText: { color: '#fff', fontSize: 12, fontWeight: '800', textTransform: 'uppercase' },

  itemCard: { backgroundColor: '#fff', padding: 16, borderRadius: 16, borderWidth: 1, borderColor: '#F1F5F9', marginBottom: 12 },
  itemRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 12 },
  itemName: { fontSize: 16, fontWeight: '800', color: '#0F172A' },
  itemCat: { fontSize: 10, color: '#64748B', fontWeight: '800', textTransform: 'uppercase', marginTop: 4 },
  statusBadge: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 8, borderWidth: 1, marginBottom: 6, alignSelf: 'flex-end' },
  ...
  stockValue: { fontSize: 16, fontWeight: '800', color: '#0F172A', textAlign: 'right' },
  stockMin: { fontSize: 10, color: '#94A3B8', textAlign: 'right', fontWeight: '600' },

  actionsRow: { flexDirection: 'row', justifyContent: 'flex-end', gap: 8, borderTopWidth: 1, borderTopColor: '#F8FAFC', paddingTop: 12 },
  actionBtnOutline: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 8, backgroundColor: '#F8FAFC', borderWidth: 1, borderColor: '#E2E8F0' },
  actionBtnText: { fontSize: 10, fontWeight: '800', color: '#475569', textTransform: 'uppercase' },
  actionBtnPrimary: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 8, backgroundColor: '#FEF3C7', borderWidth: 1, borderColor: '#F59E0B' },
  actionBtnPrimaryText: { fontSize: 10, fontWeight: '800', color: '#B45309', textTransform: 'uppercase' },
  actionBtnIcon: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 8, backgroundColor: '#F8FAFC', borderWidth: 1, borderColor: '#E2E8F0', alignItems: 'center', justifyContent: 'center' },
